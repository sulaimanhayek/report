...
class DailiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create daily" do
    assert_difference('Daily.count') do
      post dailies_url, params: { daily: { course: @daily.course, instructor: @daily.instructor, location: @daily.location } }
    end
  ...
  test "should update daily" do
    patch daily_url(@daily), params: { daily: { course: @daily.course, instructor: @daily.instructor, location: @daily.location } }
